...
(* OASIS_START *)
(* DO NOT EDIT (digest: e89d21a7efdad6be6efcb617f4f584d5) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["Election"; "Election_io"; "State"; "Rpcs"; "Raft"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["Events"; "Parameters"; "States"; "Simulator"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\017ﬂs?AZΩU„\026]ÌM—&√";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
