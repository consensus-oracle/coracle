...
(* OASIS_START *)
(* DO NOT EDIT (digest: f11ca3baacc160d3edb6b31b6f08fa2f) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["Common"; "Docs"; "Io"; "Numbergen"; "Protocol"];
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "lib";
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "dummy";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "lib"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "simulator";
                      lib_findlib_containers = []
                   });
               Library
                 ({
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("lwt.unix", None);
                           InternalLibrary "lib";
                           InternalLibrary "raft";
                           InternalLibrary "dummy";
                           InternalLibrary "simulator";
                           FindlibPackage ("cmdliner", None)
                        ];
                      bs_build_tools =
                   ...
                   {exec_custom = false; exec_main_is = "coracle_sim.ml"});
               Executable
                 ({
                     cs_name = "coracle_unix";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "coracle_unix.ml"})
            ];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\0207\0164\149œ¡\023f£Ï{4\149+\003";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
