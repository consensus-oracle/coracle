...
(* OASIS_START *)
(* DO NOT EDIT (digest: b0ede870309f64bfc8e0a88d0fe26664) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = None;
          synopsis =
            "Implementation of the Raft consensus algorithm inin OCaml";
          description = None;
          categories = [];
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "cmdline.ml"});
               Executable
                 ({
                     cs_name = "sim_raft";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "simulator.ml"})
            ];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "Bw?\154Ù\017!\148æ\132)Ç:ÚT'";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
